...
return new class extends Migration
{
    ...
    {
        Schema::create('seminaire_j_i_pays', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('type_participation', ['Co-organisateur', 'Participation active','Simple présence'])->nullable();
            $table->enum('type_organisation', ['partenaires étrangers', ' partenaires tunisiens','les deux à la fois'])->nullable();
            $table->enum('diaspora', ['Pour la diaspora', ' Avec la diaspora'])->nullable();
            ...
            $table->text('evalutation_recommandation')->nullable();
    ...
    {
        Schema::dropIfExists('seminaire_j_i_pays');
    }
};
