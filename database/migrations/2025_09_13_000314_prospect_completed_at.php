<?php
// filepath: database/migrations/2025_01_12_add_pipeline_completion_to_prospects.php
...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('prospects', function (Blueprint $table) {
            if (!Schema::hasColumn('prospects', 'pipeline_completed_at')) {
                $table->timestamp('pipeline_completed_at')->nullable()->after('pipeline_stage_id');
            }
            if (!Schema::hasColumn('prospects', 'pipeline_completed_by')) {
