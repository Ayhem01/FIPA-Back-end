...
class ProjectPipelineStage extends Model
{
    ...
    {
        return $this->hasMany(ProjectPipelineProgression::class, 'stage_id');
    }

    /**
     * Les projets actuellement à cette étape
     */
    public function activeProjects()
    {
        return Project::whereHas('pipelineProgressions', function($query) {
    ...
    /**
     * Obtenir le nombre de projets actuellement à cette étape
     */
    ...
    /**
     * Obtenir le taux de réussite pour cette étape
     */
    ...
    /**
     * Vérifier si cette étape représente une extension de projet
     */
    public function isExtensionStage(): bool
    {
        return stripos($this->name, 'extension') !== false || 
               stripos($this->description, 'extension') !== false;
    }
}